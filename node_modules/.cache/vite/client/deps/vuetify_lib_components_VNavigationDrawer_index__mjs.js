import "./chunk-Z25HR7HS.js";
import {
  makeLayoutItemProps,
  useLayoutItem
} from "./chunk-XHKX3TNU.js";
import {
  useSsrBoot
...
import {
  makeDelayProps,
  useDelay
} from "./chunk-M4CXFRSN.js";
import {
  useScopeId
} from "./chunk-3GBTIPMU.js";
import "./chunk-3ACBTIBU.js";
import "./chunk-OZK57NQP.js";
import {
  VImg
} from "./chunk-GH5PWOQS.js";
import "./chunk-PFCXEYII.js";
import {
  VDefaultsProvider
} from "./chunk-5NCUSZCG.js";
import {
  makeDisplayProps,
  useDisplay
} from "./chunk-2LT6BZYK.js";
import "./chunk-X7ZUBWJQ.js";
import "./chunk-XWP37BPS.js";
import {
  useRouter
} from "./chunk-6PNAGKNR.js";
import {
  useRtl
} from "./chunk-FEDWQQVI.js";
...
import {
  ...
  useBorder,
  useElevation
} from "./chunk-RFIWRYFL.js";
import {
  makeRoundedProps,
  useRounded
} from "./chunk-KI2GCS46.js";
import {
  makeTagProps
} from "./chunk-ELG7SSAK.js";
import {
  useBackgroundColor
} from "./chunk-ULMWNWVR.js";
import {
  useProxiedModel,
  useToggleScope
} from "./chunk-2NZNLHKY.js";
import {
  makeThemeProps,
  provideTheme
} from "./chunk-KYKMY3DY.js";
import {
  CircularBuffer,
  convertToUnit,
  genericComponent,
...
import "/home/alien/X/Main/OwnERP/Front-ERP/node_modules/vuetify/lib/components/VNavigationDrawer/VNavigationDrawer.css";
...
import { computed as computed2, onBeforeUnmount as onBeforeUnmount2, onMounted as onMounted2, onScopeDispose, shallowRef as shallowRef2, watchEffect } from "vue";
function useTouch(_ref) {
  ...
  const isDragging = shallowRef2(false);
  const dragProgress = shallowRef2(0);
  const offset = shallowRef2(0);
  let start;
...
// node_modules/vuetify/lib/components/VNavigationDrawer/VNavigationDrawer.mjs
import { computed as computed3, nextTick, ref, shallowRef as shallowRef3, toRef, Transition, watch as watch2 } from "vue";
...
var VNavigationDrawer = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const location = computed3(() => {
      return toPhysical(props.location, isRtl.value);
    });
    const isPersistent = computed3(() => props.persistent);
    const isTemporary = computed3(() => !props.permanent && (mobile.value || props.temporary));
    const isSticky = computed3(() => props.sticky && !isTemporary.value && location.value !== "bottom");
    useToggleScope(() => props.expandOnHover && props.rail != null, () => {
      watch2(isHovering, (val) => emit("update:rail", !val));
    });
    ...
    const layoutSize = computed3(() => {
      const size = isTemporary.value ? 0 : props.rail && props.expandOnHover ? Number(props.railWidth) : width.value;
      return isDragging.value ? size * dragProgress.value : size;
    });
    const elementSize = computed3(() => ["top", "bottom"].includes(props.location) ? 0 : width.value);
    const {
      layoutItemStyles,
      ...
      layoutSize,
      elementSize,
      active: computed3(() => isActive.value || isDragging.value),
      disableTransitions: computed3(() => isDragging.value),
      absolute: computed3(() => (
    ...
    const scrimColor = useBackgroundColor(computed3(() => {
      return typeof props.scrim === "string" ? props.scrim : null;
    }));
    const scrimStyles = computed3(() => ({
      ...isDragging.value ? {
    ...
    useRender(() => {
      ...
      return _createVNode(_Fragment, null, [_createVNode(props.tag, _mergeProps({
        ...
        default: () => {
          var _a, _b, _c;
          return [hasImage && _createVNode("div", {
            "key": "image",
          ...
          }, [(_a = slots.prepend) == null ? void 0 : _a.call(slots)]), _createVNode("div", {
            "class": "v-navigation-drawer__content"
          }, [(_b = slots.default) == null ? void 0 : _b.call(slots)]), slots.append && _createVNode("div", {
