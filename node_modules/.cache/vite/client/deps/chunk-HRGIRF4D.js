...
import { computed as computed2, inject, provide, ref, shallowRef as shallowRef2, unref as unref2, watchEffect as watchEffect2 } from "vue";
...
function provideDefaults(defaults, options) {
  ...
  const newDefaults = computed2(() => {
    const disabled = unref2(options == null ? void 0 : options.disabled);
    if (disabled)
      return injectedDefaults.value;
    const scoped = unref2(options == null ? void 0 : options.scoped);
    const reset = unref2(options == null ? void 0 : options.reset);
    const root = unref2(options == null ? void 0 : options.root);
...
import { camelize, capitalize as capitalize2, h } from "vue";
function createSimpleFunctional(klass) {
  let tag = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "div";
  let name = arguments.length > 2 ? arguments[2] : void 0;
  return genericComponent()({
    name: name ?? capitalize2(camelize(klass.replace(/__/g, "-"))),
    props: {
      tag: {
        type: String,
        default: tag
...
//# sourceMappingURL=chunk-HRGIRF4D.js.map
