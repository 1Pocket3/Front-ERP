...
import {
  ...
  useDelay,
  useScopeId
} from "./chunk-6PW4MGTN.js";
import {
  VDialogTransition
} from "./chunk-3NIXM2AT.js";
import {
  useDisplay
} from "./chunk-LAQZBNKZ.js";
import {
  useRtl
...
import "/home/alien/X/Main/OwnERP/Front-ERP/node_modules/vuetify/lib/components/VMenu/VMenu.css";
...
import "/home/alien/X/Main/OwnERP/Front-ERP/node_modules/vuetify/lib/components/VOverlay/VOverlay.css";
...
import { computed as computed3, shallowRef as shallowRef2, watch as watch3 } from "vue";
var makeLazyProps = propsFactory({
  eager: Boolean
}, "lazy");
function useLazy(props, active) {
  const isBooted = shallowRef2(false);
  const hasContent = computed3(() => isBooted.value || props.eager || active.value);
  watch3(active, () => isBooted.value = true);
...
import { computed as computed4, inject as inject2, onScopeDispose as onScopeDispose4, provide, reactive, readonly, shallowRef as shallowRef3, toRaw, watchEffect as watchEffect3 } from "vue";
...
function useStack(isActive, zIndex, disableGlobalStack) {
  ...
  const _zIndex = shallowRef3(+zIndex.value);
  ...
  const localTop = computed4(() => !stack.activeChildren.size);
  return {
    globalTop: readonly(globalTop),
    localTop,
    stackStyles: computed4(() => ({
...
// node_modules/vuetify/lib/components/VOverlay/VOverlay.mjs
import { computed as computed6, mergeProps as mergeProps2, onBeforeUnmount, ref as ref3, Teleport, toRef, Transition, watch as watch4 } from "vue";
...
var VOverlay = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const scrimColor = useBackgroundColor(computed6(() => {
    ...
    const potentialShadowDomRoot = computed6(() => {
      var _a;
      return (_a = activatorEl == null ? void 0 : activatorEl.value) == null ? void 0 : _a.getRootNode();
    });
    const {
      teleportTarget
    } = useTeleport(computed6(() => props.attach || props.contained || potentialShadowDomRoot.value instanceof ShadowRoot ? potentialShadowDomRoot.value : false));
    const {
      dimensionStyles
    } = useDimension(props);
    ...
    IN_BROWSER && watch4(isActive, (val) => {
      if (val) {
    ...
    const top = ref3();
    watch4(() => isActive.value && (props.absolute || props.contained) && teleportTarget.value == null, (val) => {
      if (val) {
    ...
    useRender(() => {
      var _a;
      return _createVNode(_Fragment, null, [(_a = slots.activator) == null ? void 0 : _a.call(slots, {
...
// node_modules/vuetify/lib/components/VMenu/VMenu.mjs
import { computed as computed7, inject as inject3, mergeProps as mergeProps3, nextTick as nextTick3, provide as provide2, ref as ref4, shallowRef as shallowRef4, watch as watch5 } from "vue";
...
var VMenu = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const uid = getUid();
    const id = computed7(() => props.id || `v-menu-${uid}`);
    const overlay = ref4();
    const parent = inject3(VMenuSymbol, null);
    const openChildren = shallowRef4(0);
    provide2(VMenuSymbol, {
      register() {
        ++openChildren.value;
      },
      unregister() {
    ...
    const activatorProps = computed7(() => mergeProps3({
      "aria-haspopup": "menu",
    ...
    useRender(() => {
      ...
      return _createVNode2(VOverlay, _mergeProps2({
        ...
        default: function() {
          ...
          return _createVNode2(VDefaultsProvider, {
            "root": "VMenu"
          }, {
            default: () => {
              var _a;
