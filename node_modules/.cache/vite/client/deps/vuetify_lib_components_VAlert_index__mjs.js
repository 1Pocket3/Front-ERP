...
import {
  makePositionProps,
  usePosition
} from "./chunk-YTAHT5QR.js";
import {
  makeLocationProps,
  useLocation
} from "./chunk-SVVX6ZBS.js";
...
import "/home/alien/X/Main/OwnERP/Front-ERP/node_modules/vuetify/lib/components/VAlert/VAlert.css";
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return isActive.value && _createVNode(props.tag, {
        ...
        default: () => {
          var _a, _b;
          return [genOverlays(false, "v-alert"), props.border && _createVNode("div", {
            "key": "border",
          ...
          }), ((_a = slots.text) == null ? void 0 : _a.call(slots)) ?? props.text, (_b = slots.default) == null ? void 0 : _b.call(slots)]), slots.append && _createVNode("div", {
            "key": "append",
